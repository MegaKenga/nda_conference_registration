...
@shared_task
def send_emails_task(html_message_for_nda, html_message_for_customer, person_email):
    subject_for_nda = f'Новая регистрация на конференцию {datetime.now().strftime("%Y-%m-%d %H:%M.")}'
